...
int32_t lsm6dsv32x_pin_int1_route_set(const stmdev_ctx_t *ctx,
                                      lsm6dsv32x_pin_int1_route_t *val)
{
                                      ...
                                      lsm6dsv32x_pin_int1_route_t *val)
{
  ...
  memset(val, 0x0, sizeof(lsm6dsv32x_pin_int1_route_t));
...
int32_t lsm6dsv32x_pin_int2_route_set(const stmdev_ctx_t *ctx,
                                      lsm6dsv32x_pin_int2_route_t *val)
{
                                      ...
                                      lsm6dsv32x_pin_int2_route_t *val)
{
  ...
  memset(val, 0x0, sizeof(lsm6dsv32x_pin_int2_route_t));
