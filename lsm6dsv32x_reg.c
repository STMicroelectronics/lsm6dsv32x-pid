...
{
  lsm6dsv32x_z_ofs_usr_t z_ofs_usr = {0};
  lsm6dsv32x_y_ofs_usr_t y_ofs_usr = {0};
  lsm6dsv32x_x_ofs_usr_t x_ofs_usr = {0};
  lsm6dsv32x_ctrl9_t ctrl9 = {0};
  int32_t ret = 0;
  float_t tmp = 0;
...
int32_t lsm6dsv32x_reboot(const stmdev_ctx_t *ctx)
{
  ...
  lsm6dsv32x_data_rate_t data_rate_xl = {0};
  lsm6dsv32x_data_rate_t data_rate_gy = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_ctrl1_t ctrl1 = {0};
  lsm6dsv32x_haodr_cfg_t haodr = {0};
  uint8_t sel = 0;
  int32_t ret = 0;
...
{
  lsm6dsv32x_odr_trig_cfg_t odr_trig = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_tap_cfg0_t cfg = {0};
  lsm6dsv32x_functions_enable_t func = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_spi2_int_ois_t spi2_int_ois = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_int1_ctrl_t          int1_ctrl = {0};
  lsm6dsv32x_md1_cfg_t            md1_cfg = {0};
  int32_t                    ret = 0;
                                      ...
                                      lsm6dsv32x_pin_int_route_t *val)
{
  ...
  (void)memset(val, 0x0, sizeof(lsm6dsv32x_pin_int_route_t));
...
int32_t lsm6dsv32x_pin_int2_route_set(const stmdev_ctx_t *ctx,
                                      lsm6dsv32x_pin_int_route_t *val)
{
  lsm6dsv32x_int2_ctrl_t          int2_ctrl = {0};
  lsm6dsv32x_ctrl4_t              ctrl4 = {0};
  lsm6dsv32x_ctrl7_t              ctrl7 = {0};
  lsm6dsv32x_md2_cfg_t            md2_cfg = {0};
  int32_t                    ret = 0;
...
{
  lsm6dsv32x_emb_func_int1_t emb_func_int1 = {0};
  lsm6dsv32x_md1_cfg_t md1_cfg = {0};
  int32_t ret = 0;
...
int32_t lsm6dsv32x_emb_pin_int2_route_set(const stmdev_ctx_t *ctx,
                                          const lsm6dsv32x_emb_pin_int_route_t *val)
{
  lsm6dsv32x_emb_func_int2_t emb_func_int2 = {0};
  lsm6dsv32x_md2_cfg_t md2_cfg = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_page_rw_t page_rw = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_emb_func_status_mainpage_t emb_func_status = {0};
  lsm6dsv32x_emb_func_src_t emb_func_src = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_emb_func_status_mainpage_t emb_func_status_mainpage = {0};
  lsm6dsv32x_emb_func_exec_status_t emb_func_exec_status = {0};
  lsm6dsv32x_fsm_status_mainpage_t fsm_status_mainpage = {0};
  lsm6dsv32x_mlc_status_mainpage_t mlc_status_mainpage = {0};
  lsm6dsv32x_functions_enable_t functions_enable = {0};
  lsm6dsv32x_emb_func_src_t emb_func_src = {0};
  lsm6dsv32x_fifo_status2_t fifo_status2 = {0};
  lsm6dsv32x_all_int_src_t all_int_src = {0};
  lsm6dsv32x_wake_up_src_t wake_up_src = {0};
  lsm6dsv32x_status_reg_t status_reg = {0};
  lsm6dsv32x_d6d_src_t d6d_src = {0};
  lsm6dsv32x_tap_src_t tap_src = {0};
  lsm6dsv32x_ui_status_reg_ois_t status_reg_ois = {0};
  lsm6dsv32x_status_master_t status_shub = {0};
  uint8_t buff[8] = {0};
  int32_t ret = {0};
...
{
  lsm6dsv32x_status_reg_t status = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_internal_freq_t internal_freq = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_page_address_t  page_address = {0};
  lsm6dsv32x_page_sel_t page_sel = {0};
  lsm6dsv32x_page_rw_t page_rw = {0};
  uint8_t msb = 0;
  uint8_t lsb = 0;
  int32_t ret = 0;
...
{
  lsm6dsv32x_ctrl_eis_t ctrl_eis = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_fifo_ctrl1_t fifo_ctrl1 = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = 0;
...
int32_t lsm6dsv32x_fifo_compress_algo_real_time_set(const stmdev_ctx_t *ctx,
                                                    uint8_t val)
{
  lsm6dsv32x_emb_func_en_b_t emb_func_en_b = {0};
  lsm6dsv32x_fifo_ctrl2_t fifo_ctrl2 = {0};
...
int32_t lsm6dsv32x_fifo_stop_on_wtm_set(const stmdev_ctx_t *ctx, lsm6dsv32x_fifo_event_t val)
{
  ...
  if (ret == 0)
  {
    fifo_ctrl2.stop_on_wtm = (val == LSM6DSV32X_FIFO_EV_WTM) ? 1U : 0U;
    ret = lsm6dsv32x_write_reg(ctx, LSM6DSV32X_FIFO_CTRL2, (uint8_t *)&fifo_ctrl2, 1);
  }
...
int32_t lsm6dsv32x_fifo_stop_on_wtm_get(const stmdev_ctx_t *ctx, lsm6dsv32x_fifo_event_t *val)
{
  ...
  if (ret == 0)
  {
    *val = (fifo_ctrl2.stop_on_wtm == 1u) ? LSM6DSV32X_FIFO_EV_WTM : LSM6DSV32X_FIFO_EV_FULL;
  }
...
{
  lsm6dsv32x_fifo_ctrl3_t fifo_ctrl3 = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_fifo_ctrl4_t fifo_ctrl4 = {0};
  int32_t ret = 0;
...
int32_t lsm6dsv32x_fifo_batch_counter_threshold_set(const stmdev_ctx_t *ctx,
                                                    uint16_t val)
{
  lsm6dsv32x_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  lsm6dsv32x_counter_bdr_reg2_t counter_bdr_reg2 = {0};
  int32_t ret = 0;
...
{
  uint8_t buff[2] = {0};
  lsm6dsv32x_fifo_status2_t status = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_fifo_data_out_tag_t fifo_data_out_tag = {0};
  uint8_t buff[7] = {0};
  int32_t ret = 0;
  ...
  {
    case 0x00:
      val->tag = (uint8_t)LSM6DSV32X_FIFO_EMPTY;
      break;

    case 0x01:
      val->tag = (uint8_t)LSM6DSV32X_GY_NC_TAG;
      break;

    case 0x02:
      val->tag = (uint8_t)LSM6DSV32X_XL_NC_TAG;
      break;

    case 0x03:
      val->tag = (uint8_t)LSM6DSV32X_TEMPERATURE_TAG;
      break;

    case 0x04:
      val->tag = (uint8_t)LSM6DSV32X_TIMESTAMP_TAG;
      break;

    case 0x05:
      val->tag = (uint8_t)LSM6DSV32X_CFG_CHANGE_TAG;
      break;

    case 0x06:
      val->tag = (uint8_t)LSM6DSV32X_XL_NC_T_2_TAG;
      break;

    case 0x07:
      val->tag = (uint8_t)LSM6DSV32X_XL_NC_T_1_TAG;
      break;

    case 0x08:
      val->tag = (uint8_t)LSM6DSV32X_XL_2XC_TAG;
      break;

    case 0x09:
      val->tag = (uint8_t)LSM6DSV32X_XL_3XC_TAG;
      break;

    case 0x0A:
      val->tag = (uint8_t)LSM6DSV32X_GY_NC_T_2_TAG;
      break;

    case 0x0B:
      val->tag = (uint8_t)LSM6DSV32X_GY_NC_T_1_TAG;
      break;

    case 0x0C:
      val->tag = (uint8_t)LSM6DSV32X_GY_2XC_TAG;
      break;

    case 0x0D:
      val->tag = (uint8_t)LSM6DSV32X_GY_3XC_TAG;
      break;

    case 0x0E:
      val->tag = (uint8_t)LSM6DSV32X_SENSORHUB_SLAVE0_TAG;
      break;

    case 0x0F:
      val->tag = (uint8_t)LSM6DSV32X_SENSORHUB_SLAVE1_TAG;
      break;

    case 0x10:
      val->tag = (uint8_t)LSM6DSV32X_SENSORHUB_SLAVE2_TAG;
      break;

    case 0x11:
      val->tag = (uint8_t)LSM6DSV32X_SENSORHUB_SLAVE3_TAG;
      break;

    case 0x12:
      val->tag = (uint8_t)LSM6DSV32X_STEP_COUNTER_TAG;
      break;

    case 0x13:
      val->tag = (uint8_t)LSM6DSV32X_SFLP_GAME_ROTATION_VECTOR_TAG;
      break;

    case 0x16:
      val->tag = (uint8_t)LSM6DSV32X_SFLP_GYROSCOPE_BIAS_TAG;
      break;

    case 0x17:
      val->tag = (uint8_t)LSM6DSV32X_SFLP_GRAVITY_VECTOR_TAG;
      break;

    case 0x19:
      val->tag = (uint8_t)LSM6DSV32X_SENSORHUB_NACK_TAG;
      break;

    case 0x1A:
      val->tag = (uint8_t)LSM6DSV32X_MLC_RESULT_TAG;
      break;

    case 0x1B:
      val->tag = (uint8_t)LSM6DSV32X_MLC_FILTER;
      break;

    case 0x1C:
      val->tag = (uint8_t)LSM6DSV32X_MLC_FEATURE;
      break;

    case 0x1D:
      val->tag = (uint8_t)LSM6DSV32X_XL_DUAL_CORE;
      break;

    case 0x1E:
      val->tag = (uint8_t)LSM6DSV32X_GY_ENHANCED_EIS;
      break;
...
{
  lsm6dsv32x_emb_func_fifo_en_a_t emb_func_fifo_en_a = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_emb_func_fifo_en_b_t emb_func_fifo_en_b = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_slv0_config_t slv_config = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_emb_func_cfg_t emb_func_cfg = {0};
  lsm6dsv32x_ui_int_ois_t ui_int_ois = {0};
  lsm6dsv32x_ctrl4_t ctrl4 = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_wake_up_ths_t wake_up_ths = {0};
  lsm6dsv32x_tap_cfg0_t tap_cfg0 = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_ui_ctrl2_ois_t ui_ctrl2_ois = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_ui_ctrl3_ois_t ui_ctrl3_ois = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_ctrl_status_t ctrl_status = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_emb_func_en_b_t emb_func_en_b = {0};
  lsm6dsv32x_fsm_enable_t fsm_enable = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_fsm_odr_t fsm_odr = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_ext_cfg_a_t ext_cfg_a = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_ext_cfg_b_t ext_cfg_b = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_fsm_programs_t fsm_programs = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_wake_up_dur_t wake_up_dur = {0};
  lsm6dsv32x_free_fall_t free_fall = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_emb_func_en_b_t emb_en_b = {0};
  lsm6dsv32x_emb_func_en_a_t emb_en_a = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_mlc_odr_t mlc_odr = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_pin_ctrl_t pin_ctrl = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_ui_handshake_ctrl_t ui_handshake_ctrl = {0};
  int32_t ret = 0;
...
int32_t lsm6dsv32x_ois_handshake_from_ois_set(const stmdev_ctx_t *ctx,
                                              lsm6dsv32x_ois_handshake_t val)
{
  lsm6dsv32x_spi2_handshake_ctrl_t spi2_handshake_ctrl = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_ui_ctrl1_ois_t ui_ctrl1_ois = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_tap_ths_6d_t tap_ths_6d = {0};
  int32_t ret = 0;
...
{
  lsm6dsv32x_master_config_t master_config = {0};
  int32_t ret = {0};
...
{
  lsm6dsv32x_slv0_config_t slv0_config = {0};
  int32_t ret = {0};
...
{
  lsm6dsv32x_slv0_add_t slv_add = {0};
  lsm6dsv32x_slv0_config_t slv_config = {0};
  int32_t ret = {0};
...
{
  lsm6dsv32x_emb_func_en_a_t emb_func_en_a = {0};
  int32_t ret = {0};
                                   ...
                                   lsm6dsv32x_stpcnt_mode_t val)
{
  lsm6dsv32x_emb_func_en_a_t emb_func_en_a = {0};
  lsm6dsv32x_emb_func_en_b_t emb_func_en_b = {0};
  lsm6dsv32x_pedo_cmd_reg_t pedo_cmd_reg = {0};
  int32_t ret = {0};
...
{
  lsm6dsv32x_pedo_deb_steps_conf_t pedo_deb_steps_conf = {0};
  int32_t ret = {0};
...
int32_t lsm6dsv32x_sflp_game_gbias_set(const stmdev_ctx_t *ctx,
                                       const lsm6dsv32x_sflp_gbias_t *val)
{
  lsm6dsv32x_sflp_data_rate_t sflp_odr = {0};
  lsm6dsv32x_emb_func_exec_status_t emb_func_sts = {0};
  lsm6dsv32x_data_ready_t drdy = {0};
  lsm6dsv32x_xl_full_scale_t xl_fs = {0};
  lsm6dsv32x_ctrl10_t ctrl10 = {0};
...
{
  lsm6dsv32x_sflp_odr_t sflp_odr = {0};
  int32_t ret = {0};
...
{
  lsm6dsv32x_tap_ths_6d_t tap_ths_6d = {0};
  lsm6dsv32x_tap_cfg2_t tap_cfg2 = {0};
  lsm6dsv32x_tap_cfg1_t tap_cfg1 = {0};
  int32_t ret = {0};
...
{
  lsm6dsv32x_tap_dur_t tap_dur = {0};
  int32_t ret = {0};
...
{
  lsm6dsv32x_inactivity_dur_t inactivity_dur = {0};
  int32_t ret = {0};
...
int32_t lsm6dsv32x_act_thresholds_set(const stmdev_ctx_t *ctx,
                                      const lsm6dsv32x_act_thresholds_t *val)
{
  lsm6dsv32x_inactivity_ths_t inactivity_ths = {0};
  lsm6dsv32x_inactivity_dur_t inactivity_dur = {0};
  lsm6dsv32x_wake_up_ths_t wake_up_ths = {0};
  lsm6dsv32x_wake_up_dur_t wake_up_dur = {0};
  int32_t ret = {0};
